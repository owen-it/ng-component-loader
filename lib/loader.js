...
module.exports = function (content) {
    ...
    if (query.hijacked) {
        output += `
            ...
            var componentApi = require('ng-component-api');

            componentApi.install(angular)

            hotApi.init();
            
            if(module.hot) {

                var componentHotReload = require('ng-component-hot-reload');

                componentHotReload.warpper(angular);
                ...
                if(!module.hot.data){
                    // register
                    componentHotReload.register(${hotId}, __comp_script__);
                } else {
                    // update
                    componentHotReload.update(${hotId}, __comp_script__);
                }
            }
        `
    }
