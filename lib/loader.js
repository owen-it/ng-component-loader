                ...
                function __queued__(name, module){
                    ...
                    hijacked._invokeQueue.forEach(function(proccess){
                        if (proccess[1] === 'component' && proccess[2][0] === name) {
                            console.warn('[ng-component-loader] The '+name+' component has already been registered to the '+module+' module.')
                            exist = true; return;
                        };
                    })
                    return exist;
                ...
                function __components__ (components) {
                    if(angular.isObject(components)){
                        Object.keys(components).forEach(function(name){
                            ...
                            if(!__queued__(name, hijacked.name)) hijacked.component(name, components[name]);
                        })
                    }
                    return hijacked;
                }
